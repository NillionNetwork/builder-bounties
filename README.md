...
[Nillion](https://nillion.com/) is a secure computation network that decentralized trust for high value data in the same way that blockchains decentralized transactions. Builder bounties reward developers for building awesome open source blind applications, libraries, and projects on Nillion. 
